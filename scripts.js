...
function dataUp(uEMPDATA){            //uEMPDATA is the local name for the JSON file
	...
	var ThisChart = new google.visualization.LineChart(document.getElementById('myChartDiv')); //I've created type of chart e.g. BarChart to LineChart etc
...
function GoogleUp() {
	...
	$.get("https://www.googleapis.com/fusiontables/v1/query?sql=SELECT+*+FROM+1L1rmYMaUAgK7tXaB9vt28njZA3ZAj4k8zHizBP9N&key=AIzaSyCgfAUYUUuX8vurL0WtKGYRGho11LEnsPI", dataUp, "json"); //I'm retrieving my the json 
	}
